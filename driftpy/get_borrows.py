# Taken from driftpy repository
# https://github.com/drift-labs/driftpy/blob/master/examples/get_borrows.py
# This script will get the borrow and deposit rates for a given market
